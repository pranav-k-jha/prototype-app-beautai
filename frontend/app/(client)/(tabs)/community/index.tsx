              ...
              return (
                <View style={styles.header}>
                  <UserLogoSignature
                    ...
                    onPress={() => router.replace("/(client)/(tabs)/profile")}
                    iconType="edit"
                  />
                </View>
              );
              ...
              return (
                <View style={styles.section}>
                  ...
                  {tags.length > 0 ? (
                    ...
                    <EmptyCard message="No Trending Topics" />
                  )}
                </View>
              );
