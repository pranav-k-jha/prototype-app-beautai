...
import EmptyCard from "@/components/cards/client/EmptyCard";
...
const App = () => {
  ...
  const upcomingAppointments: ArrayLike<any> = [
    {
  ...
  const savedProviders: ArrayLike<any> = [
    {
      id: "1",
      companyLogo: require("@/assets/images/companyLogo1.png"),
  ...
  const pastServices: ArrayLike<any> = [
    {
      id: 1,
                ...
                return (
                  <View style={styles.section}>
                    ...
                    {savedProviders.length > 0 ? (
                      ...
                      <EmptyCard message="No saved providers" />
                    )}
                  </View>
                );
              case "pastServices":
                return (
                  <View style={styles.section}>
                    ...
                    {pastServices.length > 0 ? (
                      ...
                      <EmptyCard message="No past services" />
                    )}
                  </View>
                );
              default:
